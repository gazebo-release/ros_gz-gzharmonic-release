## ros_gz (humble) - 0.244.12-3

The packages in the `ros_gz` repository were released into the `humble` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro humble --track humble_gzharmonic --override-release-repository-url https://github.com/gazebo-release/ros_gz-gzharmonic-release ros_gz` on `Fri, 22 Dec 2023 11:23:18 -0000`
...
- old version: `0.244.12-2`
- new version: `0.244.12-3`
...
## ros_gz (humble) - 0.244.12-2

The packages in the `ros_gz` repository were released into the `humble` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro humble --track humble_gzharmonic --override-release-repository-url https://github.com/gazebo-release/ros_gz-gzharmonic-release ros_gz` on `Thu, 21 Dec 2023 16:03:09 -0000`
...
The packages in the `ros_gz` repository were released into the `humble` distro by running `/usr/bin/bloom-release --no-pull-request --rosdistro humble --track humble_gzharmonic --override-release-repository-url https://github.com/gazebo-release/ros_gz-gzharmonic-release ros_gz` on `Tue, 19 Dec 2023 19:25:44 -0000`
